...
static const char *fonts[]          = { "IBM Plex Mono:weight=regular:size=10:antialias=true:autohint=true", "JoyPixels:weight=regular:size=10:antialias=true:autohint=true" };
static const char dmenufont[]       = "IBM Plex Mono:weight=regular:size=10:antialias=true:autohint=true";
