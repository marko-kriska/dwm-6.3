...
static const char *fonts[]          = { "Fira Code:weight=regular:size=10:antialias=true:hinting=true" };
static const char dmenufont[]       = "Fira Code:weight=regular:size=10:antialias=true:hinting=true";
