...
static const char *fonts[]          = { "Terminus:weighh=Regular:size=10:antialias=true:hinting=true" };
static const char dmenufont[]       = "Terminus:weight=Regular:size=10:antialias=true:hinting=true";
...
static const char *tags[] = { "www", "term", "doc", "vid" };
