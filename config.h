...
static const char *fonts[]          = { "Fira Mono:weight=medium:size=10:antialias=true:hinting=true", 
					"JoyPixels:weight=medium:size=10:antialias=true:hinting=true" };
static const char dmenufont[]       = "Fira Mono:weight=medium:size=10:antialias=true:hinting=true";
