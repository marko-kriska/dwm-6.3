...
static const char *fonts[]          = { "Hermit:weight=medium:size=10:antialias=true:hinting=true", 
					"JoyPixels:weight=medium:size=10:antialias=true:hinting=true" };
static const char dmenufont[]       = "Hermit:weight=medium:size=10:antialias=true:hinting=true";
