...
static const char *fonts[]          = { "JetBrains Mono Nerd Font:weight=regular:size=10:antialias=true:hinting=true", 
					"JoyPixels:weight=regular:size=10:antialias=true:hinting=true" };
static const char dmenufont[]       = "JetBrains Mono Nerd Font:weight=regular:size=10:antialias=true:hinting=true";
...
static const char *termcmd[]    = { "/bin/sh", "-c", "kitty -e fish", NULL };
