...
static const char *fonts[]          = { "Fantasque Sans Mono:weight=regular:size=12:antialias=true:hinting=true", 
					"JoyPixels:weight=regular:size=12:antialias=true:hinting=true" };
static const char dmenufont[]       = "Fantasque Sans Mono:weight=regular:size=12:antialias=true:hinting=true";
