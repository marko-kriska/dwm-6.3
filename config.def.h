...
static const char *fonts[]          = { "JetBrainsMono Nerd Font:style=medium:pixelsize=14:antialias=true:autohint=true" };
static const char dmenufont[]       = "JetBrainsMono Nerd Font:style=medium:pixelsize=14:antialias=true:autohint=true";
