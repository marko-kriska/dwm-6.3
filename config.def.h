...
static const char *fonts[]          = { "JetBrains Mono:weight=regular:size=10:antialias=true:hinting=true" };
static const char dmenufont[]       = "JetBrains Mono:weight=regular:size=10:antialias=true:hinting=true";
