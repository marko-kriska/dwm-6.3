...
static const char *fonts[]          = { "Terminus:weight=medium:size=10:antialias=true:hinting=true", 
					"JoyPixels:weight=medium:size=10:antialias=true:hinting=true" };
static const char dmenufont[]       = "Terminus:weight=medium:size=10:antialias=true:hinting=true";
