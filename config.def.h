...
static const char *fonts[]          = { "Fira Mono:weight=regular:size=10:antialias=true:hinting=true", 
					"JoyPixels:weight=regular:size=10:antialias=true:hinting=true" };
static const char dmenufont[]       = "Fira Mono:weight=regular:size=10:antialias=true:hinting=true";
